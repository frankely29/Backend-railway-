...
ZONE_MODE_PROFILES: Dict[str, ZoneScoreProfileWeights] = {
    ...
    "manhattan_v3": ZoneScoreProfileWeights(
        ...
        short_trip_penalty_weight=0.0654075,
        same_zone_retention_penalty_weight=0.1071,
        pickup_friction_penalty_weight=0.03825,
        shared_ride_penalty_weight=0.0153,
        market_saturation_penalty_weight=0.2142,
    ),
