...
ZONE_MODE_PROFILES: Dict[str, ZoneScoreProfileWeights] = {
    ...
    "manhattan_v3": ZoneScoreProfileWeights(
        ...
        short_trip_penalty_weight=0.05225,
        same_zone_retention_penalty_weight=0.0855,
        pickup_friction_penalty_weight=0.0304,
        shared_ride_penalty_weight=0.0114,
        market_saturation_penalty_weight=0.36784,
    ),
