...
def _build_shadow_props_from_row(row_map: Dict[str, Any]) -> Dict[str, Any]:
    ...
    shadow_props["demand_density_now_n_shadow"] = None if row_map.get("demand_density_now_n") is None else float(row_map.get("demand_density_now_n"))
    shadow_props["demand_density_next_n_shadow"] = None if row_map.get("demand_density_next_n") is None else float(row_map.get("demand_density_next_n"))
    shadow_props["same_zone_retention_penalty_n_shadow"] = None if row_map.get("same_zone_retention_penalty_n") is None else float(row_map.get("same_zone_retention_penalty_n"))
