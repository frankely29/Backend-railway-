...
""".strip()
    ...
    citywide_v3_negative_pre_tier_sql = f"""(
          ...
          CASE
            WHEN {manhattan_core_citywide_guard_sql}
            THEN
              0.350 * manhattan_core_saturation_penalty_n +
    ...
    normalized_support AS (
      SELECT
        *,
        ...
        CASE
          WHEN {manhattan_core_citywide_guard_sql}
          THEN LEAST(GREATEST(1.0 - (0.46 * manhattan_core_saturation_penalty_n), 0.54), 1.00)
          ELSE 1.00
      ...
      SELECT
        *,
        ...
        (
          ...
          0.35 * manhattan_core_saturation_penalty_n
    ...
    SELECT
      ...
      ({mw3.market_saturation_penalty_weight:.8f} * market_saturation_penalty_n + 0.35 * manhattan_core_saturation_penalty_n) AS earnings_shadow_saturation_penalty_manhattan_v3,
