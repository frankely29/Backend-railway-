...
def build_zone_earnings_shadow_sql(
    ...
    *,
    ...
    SELECT
      ...
      ({c3w.market_saturation_penalty_weight:.8f} * market_saturation_penalty_n + 0.040 * manhattan_core_saturation_penalty_n) AS earnings_shadow_saturation_penalty_citywide_v3,
      ...
      ({mw3.market_saturation_penalty_weight:.8f} * market_saturation_penalty_n + 0.080 * manhattan_core_saturation_penalty_n) AS earnings_shadow_saturation_penalty_manhattan_v3,
