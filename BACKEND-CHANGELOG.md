...
## Current pass: Strategic Points — investigate each + add 3 missing high-value districts
...
- Result: **24 → 27 strategic points**. 0 duplicate names, 0 clusters < 3 members, addresses added for all new POIs; `test_holiday_calendar` passes (8/8).
