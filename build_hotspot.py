    ...
    try:
        ...
        for row in shadow_rows:
            ...
            shadow_by_key[(int(pu_id), int(s_dow_m), int(s_bin_start_min))] = {
                ...
                "airport_exit_share_shadow": None if airport_exit_share_shadow is None else float(airport_exit_share_shadow),
                "out_of_scored_network_exit_share_shadow": None if out_of_scored_network_exit_share_shadow is None else float(out_of_scored_network_exit_share_shadow),
                "short_external_exit_share_6mi_30min_shadow": None if short_external_exit_share_6mi_30min_shadow is None else float(short_external_exit_share_6mi_30min_shadow),
                "short_external_exit_share_8mi_40min_shadow": None if short_external_exit_share_8mi_40min_shadow is None else float(short_external_exit_share_8mi_40min_shadow),
                "good_long_external_exit_share_shadow": None if good_long_external_exit_share_shadow is None else float(good_long_external_exit_share_shadow),
                "airport_exit_share_n_shadow": None if airport_exit_share_n_shadow is None else float(airport_exit_share_n_shadow),
                "out_of_scored_network_exit_share_n_shadow": None if out_of_scored_network_exit_share_n_shadow is None else float(out_of_scored_network_exit_share_n_shadow),
                "short_external_exit_share_6mi_30min_n_shadow": None if short_external_exit_share_6mi_30min_n_shadow is None else float(short_external_exit_share_6mi_30min_n_shadow),
                "short_external_exit_share_8mi_40min_n_shadow": None if short_external_exit_share_8mi_40min_n_shadow is None else float(short_external_exit_share_8mi_40min_n_shadow),
                "good_long_external_exit_share_n_shadow": None if good_long_external_exit_share_n_shadow is None else float(good_long_external_exit_share_n_shadow),
                "return_risk_shadow": None if return_risk_shadow is None else float(return_risk_shadow),
                "escape_quality_shadow": None if escape_quality_shadow is None else float(escape_quality_shadow),
                "safe_return_risk": None if safe_return_risk is None else float(safe_return_risk),
                "safe_escape_quality": None if safe_escape_quality is None else float(safe_escape_quality),
                "safe_airport_exit": None if safe_airport_exit is None else float(safe_airport_exit),
                "safe_external_exit": None if safe_external_exit is None else float(safe_external_exit),
                "safe_short_external": None if safe_short_external is None else float(safe_short_external),
                "safe_good_long_external": None if safe_good_long_external is None else float(safe_good_long_external),
                "safe_downstream": None if safe_downstream is None else float(safe_downstream),
                "citywide_trap_adjustment_factor": None if citywide_trap_adjustment_factor is None else float(citywide_trap_adjustment_factor),
                "queens_trap_adjustment_factor": None if queens_trap_adjustment_factor is None else float(queens_trap_adjustment_factor),
                "bronx_wash_heights_trap_adjustment_factor": None if bronx_wash_heights_trap_adjustment_factor is None else float(bronx_wash_heights_trap_adjustment_factor),
                "brooklyn_trap_adjustment_factor": None if brooklyn_trap_adjustment_factor is None else float(brooklyn_trap_adjustment_factor),
                "staten_island_trap_adjustment_factor": None if staten_island_trap_adjustment_factor is None else float(staten_island_trap_adjustment_factor),
                "manhattan_trap_adjustment_factor": None if manhattan_trap_adjustment_factor is None else float(manhattan_trap_adjustment_factor),
                "earnings_shadow_score_citywide_v3_trap_candidate": None if earnings_shadow_score_citywide_v3_trap_candidate is None else float(earnings_shadow_score_citywide_v3_trap_candidate),
                "earnings_shadow_score_manhattan_v3_trap_candidate": None if earnings_shadow_score_manhattan_v3_trap_candidate is None else float(earnings_shadow_score_manhattan_v3_trap_candidate),
                "earnings_shadow_score_bronx_wash_heights_v3_trap_candidate": None if earnings_shadow_score_bronx_wash_heights_v3_trap_candidate is None else float(earnings_shadow_score_bronx_wash_heights_v3_trap_candidate),
                "earnings_shadow_score_queens_v3_trap_candidate": None if earnings_shadow_score_queens_v3_trap_candidate is None else float(earnings_shadow_score_queens_v3_trap_candidate),
                "earnings_shadow_score_brooklyn_v3_trap_candidate": None if earnings_shadow_score_brooklyn_v3_trap_candidate is None else float(earnings_shadow_score_brooklyn_v3_trap_candidate),
                "earnings_shadow_score_staten_island_v3_trap_candidate": None if earnings_shadow_score_staten_island_v3_trap_candidate is None else float(earnings_shadow_score_staten_island_v3_trap_candidate),
                "earnings_shadow_confidence_citywide_v3_trap_candidate": None if earnings_shadow_confidence_citywide_v3_trap_candidate is None else float(earnings_shadow_confidence_citywide_v3_trap_candidate),
                "earnings_shadow_confidence_manhattan_v3_trap_candidate": None if earnings_shadow_confidence_manhattan_v3_trap_candidate is None else float(earnings_shadow_confidence_manhattan_v3_trap_candidate),
                "earnings_shadow_confidence_bronx_wash_heights_v3_trap_candidate": None if earnings_shadow_confidence_bronx_wash_heights_v3_trap_candidate is None else float(earnings_shadow_confidence_bronx_wash_heights_v3_trap_candidate),
                "earnings_shadow_confidence_queens_v3_trap_candidate": None if earnings_shadow_confidence_queens_v3_trap_candidate is None else float(earnings_shadow_confidence_queens_v3_trap_candidate),
                "earnings_shadow_confidence_brooklyn_v3_trap_candidate": None if earnings_shadow_confidence_brooklyn_v3_trap_candidate is None else float(earnings_shadow_confidence_brooklyn_v3_trap_candidate),
                "earnings_shadow_confidence_staten_island_v3_trap_candidate": None if earnings_shadow_confidence_staten_island_v3_trap_candidate is None else float(earnings_shadow_confidence_staten_island_v3_trap_candidate),
                "earnings_shadow_rating_citywide_v3_trap_candidate": None if earnings_shadow_rating_citywide_v3_trap_candidate is None else int(earnings_shadow_rating_citywide_v3_trap_candidate),
                "earnings_shadow_bucket_citywide_v3_trap_candidate": earnings_shadow_bucket_citywide_v3_trap_candidate,
                "earnings_shadow_color_citywide_v3_trap_candidate": earnings_shadow_color_citywide_v3_trap_candidate,
                "earnings_shadow_rating_manhattan_v3_trap_candidate": None if earnings_shadow_rating_manhattan_v3_trap_candidate is None else int(earnings_shadow_rating_manhattan_v3_trap_candidate),
                "earnings_shadow_bucket_manhattan_v3_trap_candidate": earnings_shadow_bucket_manhattan_v3_trap_candidate,
                "earnings_shadow_color_manhattan_v3_trap_candidate": earnings_shadow_color_manhattan_v3_trap_candidate,
                "earnings_shadow_rating_bronx_wash_heights_v3_trap_candidate": None if earnings_shadow_rating_bronx_wash_heights_v3_trap_candidate is None else int(earnings_shadow_rating_bronx_wash_heights_v3_trap_candidate),
                "earnings_shadow_bucket_bronx_wash_heights_v3_trap_candidate": earnings_shadow_bucket_bronx_wash_heights_v3_trap_candidate,
                "earnings_shadow_color_bronx_wash_heights_v3_trap_candidate": earnings_shadow_color_bronx_wash_heights_v3_trap_candidate,
                "earnings_shadow_rating_queens_v3_trap_candidate": None if earnings_shadow_rating_queens_v3_trap_candidate is None else int(earnings_shadow_rating_queens_v3_trap_candidate),
                "earnings_shadow_bucket_queens_v3_trap_candidate": earnings_shadow_bucket_queens_v3_trap_candidate,
                "earnings_shadow_color_queens_v3_trap_candidate": earnings_shadow_color_queens_v3_trap_candidate,
                "earnings_shadow_rating_brooklyn_v3_trap_candidate": None if earnings_shadow_rating_brooklyn_v3_trap_candidate is None else int(earnings_shadow_rating_brooklyn_v3_trap_candidate),
                "earnings_shadow_bucket_brooklyn_v3_trap_candidate": earnings_shadow_bucket_brooklyn_v3_trap_candidate,
                "earnings_shadow_color_brooklyn_v3_trap_candidate": earnings_shadow_color_brooklyn_v3_trap_candidate,
                "earnings_shadow_rating_staten_island_v3_trap_candidate": None if earnings_shadow_rating_staten_island_v3_trap_candidate is None else int(earnings_shadow_rating_staten_island_v3_trap_candidate),
                "earnings_shadow_bucket_staten_island_v3_trap_candidate": earnings_shadow_bucket_staten_island_v3_trap_candidate,
                "earnings_shadow_color_staten_island_v3_trap_candidate": earnings_shadow_color_staten_island_v3_trap_candidate,
                "earnings_shadow_delta_citywide_v3_trap_candidate": None if earnings_shadow_delta_citywide_v3_trap_candidate is None else float(earnings_shadow_delta_citywide_v3_trap_candidate),
                "earnings_shadow_delta_manhattan_v3_trap_candidate": None if earnings_shadow_delta_manhattan_v3_trap_candidate is None else float(earnings_shadow_delta_manhattan_v3_trap_candidate),
                "earnings_shadow_delta_bronx_wash_heights_v3_trap_candidate": None if earnings_shadow_delta_bronx_wash_heights_v3_trap_candidate is None else float(earnings_shadow_delta_bronx_wash_heights_v3_trap_candidate),
                "earnings_shadow_delta_queens_v3_trap_candidate": None if earnings_shadow_delta_queens_v3_trap_candidate is None else float(earnings_shadow_delta_queens_v3_trap_candidate),
                "earnings_shadow_delta_brooklyn_v3_trap_candidate": None if earnings_shadow_delta_brooklyn_v3_trap_candidate is None else float(earnings_shadow_delta_brooklyn_v3_trap_candidate),
                "earnings_shadow_delta_staten_island_v3_trap_candidate": None if earnings_shadow_delta_staten_island_v3_trap_candidate is None else float(earnings_shadow_delta_staten_island_v3_trap_candidate),
