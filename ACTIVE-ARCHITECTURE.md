...
- Backend shadow output now includes `citywide_v2`, `manhattan_v2`, and `bronx_wash_heights_v2`; citywide remains active outside special scopes and Manhattan/Bronx-Wash Heights cutovers stay scope-specific in frontend/runtime phases.
